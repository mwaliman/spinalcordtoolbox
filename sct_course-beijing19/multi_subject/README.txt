...
- Update parameters.sh file to your local config (notably variable PATH_PARENT)
- Update permission: chmod 775 process_data.sh
...
This pipeline has been tested on v4.0.0, which can be downloaded here:
