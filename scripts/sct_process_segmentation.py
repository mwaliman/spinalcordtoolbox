...
"""
    ...
    parser.add_option(
        name="-h", type_value=None, description="display this help", mandatory=False
    )
>>>>>>> Stashed changes
...
>>>>>>> Stashed changes
    ...
    save_as_csv(
        metrics_agg_merged, file_out, fname_in=fname_segmentation, append=append
    )
